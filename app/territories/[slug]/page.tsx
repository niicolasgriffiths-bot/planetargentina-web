      ...
      <section className="relative min-h-[88vh]">
        ...
        <div className="absolute inset-x-0 bottom-0 px-6 pb-16 text-paper md:px-10 md:pb-20">
          <FadeIn className="max-w-4xl">
            ...
            />
            <div className="flex flex-wrap items-center gap-3 text-[12px] uppercase tracking-editorial text-paper/60">
            ...
            <p className="mt-5 text-[12px] uppercase tracking-editorial text-paper/58">
        ...
        <FadeIn delay={0.1} className="grid gap-6 md:grid-cols-2">
          {territory.gallery.map((item, index) => (
            ...
            >
              ...
              <div className="absolute left-4 top-4 z-10 rounded-full bg-black/45 px-3 py-1 text-[11px] uppercase tracking-editorial text-paper">
      ...
      <section className="mx-auto max-w-7xl px-6 md:px-10">
        <FadeIn className="border border-black/10 bg-[#111111] p-6 text-paper shadow-haze md:p-10">
          <div className="grid gap-8 md:grid-cols-[0.95fr_1.05fr] md:items-center">
            <div>
              <p className="text-[12px] uppercase tracking-editorial text-paper/45">
              ...
              <p className="mt-6 text-[12px] uppercase tracking-editorial text-paper/45">
                {localizeText(territory.route, language)}
              </p>
            </div>
